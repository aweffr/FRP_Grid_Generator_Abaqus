...
# modelFile = shelve.open("D:\\abaqus_execpy\\TrueModel\\data\\modelPoints-7.dat")
# time = modelFile["time"]
# modelFile.close()
...
# PartC Meshing
myPartC.seedPart(deviationFactor=0.1, minSizeFactor=0.1, size=0.1)
...
myPartC.assignBeamSectionOrientation(
    method=N1_COSINES, 
    n1=(0.0, 0.0, -1.0), 
    region=partSetC)
